...
def main():
    ...
    def send_hit(chat_id, res, cookie, duration="N/A", include_screenshot=True, add_back_button=False):
        ...
        msg = (
            ...
            f"{th['link_h']}\n"
            f"<b>├ 💻 PC:</b> <a href='{res.get('link') or login_url}'>🔗 Click Here</a>\n"
            f"<b>├ 📱 Mobile:</b> <a href='{res.get('link2') or login_url}'>🔗 Click Here</a>\n"
            f"<b>├ 📺 TV Page:</b> <a href='{res.get('link3') or login_url}'>🔗 Click Here</a>\n"
            f"<b>└</b> <i>{th['valid']}</i>\n\n"
